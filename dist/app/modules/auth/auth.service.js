...
const changePassword = (oldPassword, newPassword, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!user) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "auth service User do not recieved", "");
    }
    ...
    if (isSamePassword) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "New password cannot be the same as old password", "");
    }
...
const resetPassword = (payload, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    if (payload.id != decodedToken.userId) {
        throw new AppError_1.default(http_status_codes_1.default.UNAUTHORIZED, "You are not authorized to reset password", "");
    }
