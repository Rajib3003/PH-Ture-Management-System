...
const updateUser = (userId, payload, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userIdExist = yield user_model_1.User.findById(userId);
    if (!userIdExist) {
        throw new AppError_1.default(http_status_codes_1.default.NOT_FOUND, "User Id Not Found", "");
    }
    if (decodedToken.role === user_interface_1.Role.ADMIN && userIdExist.role === user_interface_1.Role.SUPER_ADMIN) {
        throw new AppError_1.default(http_status_codes_1.default.FORBIDDEN, "You are not Authorized", "");
    }
    if (payload.role) {
        if (decodedToken.role === user_interface_1.Role.USER || decodedToken.role === user_interface_1.Role.GUIDE) {
...
const getMe = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.User.findById(userId).select('-password -auths -__v');
    if (!user) {
