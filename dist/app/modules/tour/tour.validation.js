...
exports.updateTourZodSchema = exports.createTourZodSchema = exports.updateTourTypesZodSchema = exports.createTourTypesZodSchema = void 0;
// import { Types } from "mongoose";
const zod_1 = __importDefault(require("zod"));
exports.createTourTypesZodSchema = zod_1.default.object({
    name: zod_1.default
        .string()
...
exports.updateTourTypesZodSchema = zod_1.default.object({
    name: zod_1.default
        .string()
        .refine(val => typeof val === "string", {
        message: "Name must be a string",
